...
(function () {
  ...
  const I18N = {
    en: {
      ...
      "nav.web3": "Early access",
      "foot.web3": "Early access",
      "web3.metaTitle": "Early access — Go!Gosling",
      "web3.metaDesc": "Reserve early access to Go!Gosling with your Ethereum wallet — a free signature, no transaction. We only ever see your public address.",
      "web3.eyebrow": "Early access",
      "web3.title": "Reserve your spot with your wallet.",
      "web3.lead": "Connect an Ethereum wallet and sign a free message to join the Go!Gosling early-access list. No transaction, no gas — and we only ever see your public address.",
      "web3.unsupported.title": "You'll need an Ethereum wallet",
      "web3.unsupported.body": "Install a browser wallet like MetaMask, then come back to reserve your spot.",
      "web3.get": "Get a wallet",
      "web3.connect.title": "Connect your wallet",
      "web3.connect.body": "One click to connect — we never request a transaction.",
      "web3.connect": "Connect wallet",
      "web3.connecting": "Connecting… confirm in your wallet.",
      "web3.connected.title": "Wallet connected",
      "web3.connected.body": "Sign a free message to lock in your early-access spot.",
      "web3.reserve": "Reserve early access",
      "web3.signing": "Confirm the signature in your wallet…",
      "web3.joined.title": "You're on the early-access list",
      "web3.joined.body": "We'll reach this wallet first when early access opens.",
      "web3.disconnect": "Disconnect",
      "web3.errTitle": "Couldn't connect",
      "web3.retry": "Try again",
      "web3.privacy": "Privacy first: connecting is optional and reads only your public wallet address. Reserving is a free off-chain signature — never a transaction, and never access to your funds.",
    ...
    zh: {
      ...
      "nav.web3": "抢先体验",
      "foot.web3": "抢先体验",
      "web3.metaTitle": "抢先体验 — Go!Gosling",
      "web3.metaDesc": "用以太坊钱包预约 Go!Gosling 抢先体验——一次免费签名，无需交易。我们只读取你的公开地址。",
      "web3.eyebrow": "抢先体验",
      "web3.title": "用钱包预约你的名额。",
      "web3.lead": "连接以太坊钱包并签署一条免费消息，即可加入 Go!Gosling 抢先体验名单。无交易、无 Gas——而且我们只读取你的公开地址。",
      "web3.unsupported.title": "你需要一个以太坊钱包",
      "web3.unsupported.body": "安装 MetaMask 等浏览器钱包后，回来预约你的名额。",
      "web3.get": "获取钱包",
      "web3.connect.title": "连接你的钱包",
      "web3.connect.body": "一键连接——我们绝不请求任何交易。",
      "web3.connect": "连接钱包",
      "web3.connecting": "连接中……请在钱包中确认。",
      "web3.connected.title": "钱包已连接",
      "web3.connected.body": "签署一条免费消息，锁定你的抢先体验名额。",
      "web3.reserve": "预约抢先体验",
      "web3.signing": "请在钱包中确认签名……",
      "web3.joined.title": "你已在抢先体验名单中",
      "web3.joined.body": "抢先体验开放时，我们会优先联系这个钱包。",
      "web3.disconnect": "断开连接",
      "web3.errTitle": "连接失败",
      "web3.retry": "重试",
      "web3.privacy": "隐私优先：连接是可选的，且只读取你的公开钱包地址。预约是一次免费的链下签名——绝非交易，也绝不触及你的资金。",
